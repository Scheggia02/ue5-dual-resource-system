...
/**
 * This is the base attribute set class for our game, it is used to define attributes that are common to all characters in our game, such as health, mana, etc.
 */
UCLASS()
class PROJECTAD_API UDRSAttributeSet : public UAttributeSet
{
 GENERATED_BODY()
